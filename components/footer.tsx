    ...
    <footer className="py-8 bg-sky-900 text-slate-300 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-semibold flex items-center">
                Stephen Kihuni <Leaf className="h-4 w-4 ml-1 text-sky-400" />
              </p>
              <p className="text-sm text-sky-400">Django sky Explorer</p>
            </div>
          </div>
          ...
          <div className="text-sm text-sky-400">© {currentYear} Stephen Kihuni. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )
